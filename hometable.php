                ...
                <div class="service-time middle" style="background:#0071d1;">
                    ...
                    <div class="time-table-section">
                        <ul>
                            ...
                            // Përdorimi i referencës në foreach për të mundësuar modifikimet e mundshme direkt në elementet e vargut
                            foreach($workingHours as $days => &$hours) {
                                echo "<li><span class='left'>" . $days . "</span><span class='right'>" . $hours . "</span></li>";
                            }
                            unset($hours); // Largimi i referencës për të parandaluar efekte anësore të mundshme
                            ?>
                        </ul>
                    </div>
                </div>
