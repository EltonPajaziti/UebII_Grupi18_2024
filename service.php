...
class Termini { 
    ...
    public function ruaj() { 
        global $pdo; 
        // Përfshini kolonën 'message' dhe variablen $this->mesazhi në query dhe 
//në execute 
        $sql = "INSERT INTO appointments (patient_name, patient_email, 
appointment_date, appointment_time, doctor_name, message) VALUES (?, ?, ?, ?, ?, 
?)"; 
        $stmt = $pdo->prepare($sql); 
        $stmt->execute([$this->emri, $this->email, $this->data, $this->ora, 
$this->doktori, $this->mesazhi]); 
                  ...
                  <div class="inner-services"> 
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> 
                        <div class="serv"> 
                           ...
                           <p> Experience the epitome of comfort and care with 
our premium facilities, where every detail is tailored to ensure your utmost 
satisfaction and well-being.</p> 
                     ...
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> 
                        <div class="serv"> 
                           ...
                           <p> Explore innovation in healthcare with our 
expansive laboratory, equipped with state-of-the-art technology.</p> 
                        </div> 
                     </div> 
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> 
                        <div class="serv"> 
                           ...
                           <p>Uncover personalized care like never before with 
our team of meticulous specialists, each committed to providing comprehensive 
evaluations.</p> 
                        </div> 
                     </div> 
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> 
                        <div class="serv"> 
                           ...
                           <p>Delight in peace of mind knowing your little ones 
are in nurturing hands at our children's care center</p> 
                        </div> 
                     </div> 
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> 
                        <div class="serv"> 
                           ...
                           <p>Immerse yourself in an ambiance of sophistication 
and tranquility with our fine infrastructure.</p> 
                        </div> 
                     </div> 
                     <div class="col-lg-4 col-md-6 col-sm-6 col-xs-12"> 
                        <div class="serv"> 
                           ...
                           <p>Rest assured knowing life-saving resources are 
always within reach with our anytime blood bank.</p> 
                        </div> 
                     </div> 
                  </div> 
               </div> 
...
required /> 
        ...
        <!-- Emri i Mjekut --> 
        <div class="form-group"> 
        <select class="form-control" name="doctorName" id="doctorSelect" 
required> 
            <option value="">Doctor Name</option> 
            <!-- emrat e userave qe e kan position doktor, duke i marr me api 
prej databazes  --> 
        </select> 
    </div> 
...
name="message" placeholder="Your Message..." required></textarea> 
        ...
        <!-- Butoni Submit --> 
        <div class="form-group"> 
            <div class="center"><button type="submit" 
...
{ 
        $errors[] = "The name is required and must contain only letters and 
spaces."; 
    } 
...
FILTER_VALIDATE_EMAIL)) { 
    ...
    if (empty($errors)) { 
        ...
        $doctorName = htmlspecialchars($_POST['doctorName'], ENT_QUOTES, 'UTF
8'); 
        ...
        echo "<script>alert('The reservation was made successfully. $name has 
made an appointment with the doctor: $doctorName, on $day at $time.');</script>"; 
    } else { 
